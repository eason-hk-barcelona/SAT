...
{
public:
    Doubly_Linked_List() : head(nullptr), tail(nullptr), length(0) {}

    Doubly_Linked_List(std::initializer_list<T> values) : head(nullptr), tail(nullptr)
    {
    ...
    Doubly_Linked_List(const Doubly_Linked_List<T>& other) : head(nullptr), tail(nullptr)
    {
